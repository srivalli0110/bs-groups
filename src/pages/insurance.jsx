      ...
      <section className="relative min-h-[550px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
          ...
          <p className="mt-6 text-slate-300 text-lg md:text-xl leading-8 max-w-2xl">
            Protection and peace of mind for you, your family and
            your business.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-slate-300 text-lg leading-8 mb-6">
                B&S GROUPS helps customers explore insurance solutions
                designed to provide financial protection and greater
                peace of mind against unexpected situations.
              </p>

              <p className="text-slate-300 text-lg leading-8">
                We assist individuals, families and businesses in
                understanding different protection options and finding
                solutions suited to their specific requirements.
              </p>
              ...
              {features.map((feature) => (
                ...
                >
                  ...
                  <p className="text-slate-400 mt-3 leading-6">
                    Explore suitable protection options with
