    ...
    <div className="min-h-screen bg-[#07131F] text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="text-slate-300 text-lg leading-8 mb-8">
          ...
          adopt clean and reliable renewable energy. Our solutions are
          suitable for residential, commercial and industrial requirements.
        </p>

        <p className="text-slate-300 text-lg leading-8 mb-12">
          We focus on providing practical solar solutions that can help
          reduce dependence on conventional electricity and support a more
          sustainable future.
        </p>
